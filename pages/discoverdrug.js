    ...
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
        <div className='col-span-4'>
          ...
          <button className='px-8 py-2 mt-4 mr-8'><a href='https://discover-drug-app-deploy.herokuapp.com' target='_blank' rel='noreferrer'>Demo</a></button>
          <button className='px-8 py-2 mt-4'><a href='https://github.com/emilyjryan/project-two' target='_blank' rel='noreferrer'>Code</a></button>
        </div>
